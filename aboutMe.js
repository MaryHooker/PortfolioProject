...
function messageOnClick(event) {
    ...
    while (doYouLikeColor == '') {
        ...
        if (doYouLikeColor == 'no' || doYouLikeColor == 'No') {   //prompt the user for what colors they would like more and store it in a variable
    ...
    colorSchemeBetter.forEach((answer) => {   //print the array in the console
    ...
    if (doYouLikeColor == 'yes' || doYouLikeColor == 'Yes') {   //prompt the user for why they like the color scheme and store it in a variable
    ...
    colorSchemeLike.forEach((answer) => {   //print the array in the console
